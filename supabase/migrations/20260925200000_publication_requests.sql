-- Histórico durável das solicitações de publicação.
begin;
...
create index if not exists publication_requests_content_id_idx
  on public.publication_requests (content_id);
